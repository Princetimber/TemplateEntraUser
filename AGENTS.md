...
**Copy-EntraUser** — a PowerShell module built with the [Sampler](https://github.com/gaelcolas/Sampler) framework.
...
source/
  ...
  en-US/            # Help files
  Copy-EntraUser.psm1   # Root module (dot-sources Public/ and Private/)
