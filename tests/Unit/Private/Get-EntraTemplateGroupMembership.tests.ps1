...
BeforeAll {
    Import-Module Microsoft.Graph.Users, Microsoft.Graph.Identity.Governance -Force
    . (Join-Path $PSScriptRoot '../../../source/Private/Get-EntraTemplateGroupMembership.ps1')
}
