...
# depends on are installed at a compatible version, before any Graph call
# is attempted. Fails fast with an actionable error naming exactly which
# module and minimum version is missing. Never installs a module
# automatically -- installing modules is itself a side effect requiring
# operator consent. Throws a terminating error on the first
# missing/under-versioned module.
